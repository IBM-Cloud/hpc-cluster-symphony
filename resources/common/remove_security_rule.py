...
def delete_security_group_rule(
    region, access_token, security_group_id, security_group_rule_id
):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--region", type=str, dest="region", help="ibmcloud region", required=True
    )
    parser.add_argument(
        "--apikey", type=str, dest="apikey", help="ibmcloud apikey", required=True
    )
    parser.add_argument(
        "--sg_id", type=str, dest="sg_id", help="security group id", required=True
    )
    parser.add_argument(
        "--sg_rule_id",
        type=str,
        dest="sg_rule_id",
        help="security_group_rule_id",
        required=True,
    )
