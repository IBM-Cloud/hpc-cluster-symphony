...
/*
    ...
    Few Dynamic values are added as part of the tunables based on max_mbps and vpcu count
*/
...
locals {
  ...
  using_direct_connection   = (tobool(var.using_direct_connection) == true) ? true : false
}
