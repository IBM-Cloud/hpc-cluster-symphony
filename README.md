...
| <a name="input_dedicated_host_type_name"></a> [dedicated\_host\_type\_name](#input\_dedicated\_host\_type\_name) | Specify the virtual server instance profile class name on dedicated hosts (i.e., bx2, cx2, or mx2) to be used to create compute nodes for the Spectrum Symphony cluster. [Learn more](https://cloud.ibm.com/docs/vpc?topic=vpc-dh-profiles). | `string` | `"bx2"` | no |
