...
| [ibm_is_instance.management](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.23.0/docs/resources/is_instance) | resource |
| [ibm_is_instance.primary](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.23.0/docs/resources/is_instance) | resource |
| [ibm_is_instance.secondary](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.23.0/docs/resources/is_instance) | resource |
...
| <a name="input_worker_node_min_count"></a> [worker\_node\_min\_count](#input\_worker\_node\_min\_count) | The minimum number of worker nodes. This is the number of worker nodes that will be provisioned at the time the cluster is created. Enter a value in the range 0 - 500. | `number` | `1` | no |
