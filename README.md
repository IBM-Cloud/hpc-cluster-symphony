...
# Fileshare Setup
IBM Fileshare is used as the default storage. The storage volume is mounted to the /mnt/data directory which is exported to share with Symphony cluster nodes.
...
###### 1. Steps to validate the cluster status
...
###### 2. Steps to validate host factory
```
...
###### 4. steps to validate spectrum scale integration
...
###### 5. Steps to login a windows worker node
...
| <a name="module_cluster_file_share"></a> [cluster\_file\_share](#module\_cluster\_file\_share) | ./resources/ibmcloud/storage/file_share/ | n/a |
...
| <a name="module_custom_file_share"></a> [custom\_file\_share](#module\_custom\_file\_share) | ./resources/ibmcloud/storage/file_share/ | n/a |
...
| <a name="module_windows_cos_fs"></a> [windows\_cos\_fs](#module\_windows\_cos\_fs) | ./resources/ibmcloud/storage/windows_cos_fs/ | n/a |
...
| [ibm_dns_custom_resolvers.dns_custom_resolver](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/dns_custom_resolvers) | data source |
| [ibm_iam_auth_token.token](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/iam_auth_token) | data source |
| [ibm_is_bare_metal_server_profile.storage_bare_metal_server_profile](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_bare_metal_server_profile) | data source |
| [ibm_is_bare_metal_server_profile.worker_bare_metal_server_profile](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_bare_metal_server_profile) | data source |
| [ibm_is_dedicated_host_profiles.worker](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_dedicated_host_profiles) | data source |
| [ibm_is_image.baremetal_image](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_image) | data source |
| [ibm_is_image.image](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_image) | data source |
| [ibm_is_image.scale_image](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_image) | data source |
| [ibm_is_image.stock_image](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_image) | data source |
| [ibm_is_image.windows_worker_image](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_image) | data source |
| [ibm_is_instance_profile.login](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_instance_profile) | data source |
| [ibm_is_instance_profile.management_node](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_instance_profile) | data source |
| [ibm_is_instance_profile.spectrum_scale_storage](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_instance_profile) | data source |
| [ibm_is_instance_profile.storage](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_instance_profile) | data source |
| [ibm_is_instance_profile.worker](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_instance_profile) | data source |
| [ibm_is_region.region](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_region) | data source |
| [ibm_is_ssh_key.ssh_key](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_ssh_key) | data source |
| [ibm_is_subnet.subnet_id](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_subnet) | data source |
| [ibm_is_subnet_reserved_ips.dns_reserved_ips](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_subnet_reserved_ips) | data source |
| [ibm_is_vpc.existing_vpc](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_vpc) | data source |
| [ibm_is_vpc.vpc](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_vpc) | data source |
| [ibm_is_vpc_address_prefixes.existing_vpc](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_vpc_address_prefixes) | data source |
| [ibm_is_zone.zone](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/is_zone) | data source |
| [ibm_resource_group.rg](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.71.1/docs/data-sources/resource_group) | data source |
