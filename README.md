...
| [ibm_is_bare_metal_server_profile.worker_bare_metal_server_profile](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.46.0/docs/data-sources/is_bare_metal_server_profile) | data source |
...
| [ibm_is_image.baremetal_image](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.46.0/docs/data-sources/is_image) | data source |
...
| <a name="input_scale_storage_node_count"></a> [scale\_storage\_node\_count](#input\_scale\_storage\_node\_count) | The number of Spectrum Scale storage nodes that are provisioned at the time the cluster is created. Enter a value in the range 2 - 18. It has to be divisible by 2. | `number` | `4` | no |
